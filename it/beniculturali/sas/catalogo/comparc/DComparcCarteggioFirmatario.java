 ...
 *       &lt;sequence>
 *         &lt;element name="text_nome_firmatario_carteggio">
 *           &lt;simpleType>
...
@XmlType(name = "", propOrder = {
    "textNomeFirmatarioCarteggio",
    "fkVocQualificaAttoreCarteggio",
    "fkVocRuoloAttoreCarteggio",
    "textNote"
})
@XmlRootElement(name = "d_comparc_carteggio_firmatario")
public class DComparcCarteggioFirmatario {

    @XmlElement(name = "text_nome_firmatario_carteggio", required = true, nillable = true)
    protected String textNomeFirmatarioCarteggio;
    ...
    protected JAXBElement<DComparcCarteggioFirmatario.FkVocQualificaAttoreCarteggio> fkVocQualificaAttoreCarteggio;
    ...
    protected JAXBElement<DComparcCarteggioFirmatario.FkVocRuoloAttoreCarteggio> fkVocRuoloAttoreCarteggio;
    ...
    /**
     * Gets the value of the textNomeFirmatarioCarteggio property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getTextNomeFirmatarioCarteggio() {
        return textNomeFirmatarioCarteggio;
    }

    /**
     * Sets the value of the textNomeFirmatarioCarteggio property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setTextNomeFirmatarioCarteggio(String value) {
        this.textNomeFirmatarioCarteggio = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DComparcCarteggioFirmatario.FkVocQualificaAttoreCarteggio }{@code >}
     *     
     */
    public JAXBElement<DComparcCarteggioFirmatario.FkVocQualificaAttoreCarteggio> getFkVocQualificaAttoreCarteggio() {
     ...
     *     
     */
    public void setFkVocQualificaAttoreCarteggio(JAXBElement<DComparcCarteggioFirmatario.FkVocQualificaAttoreCarteggio> value) {
        this.fkVocQualificaAttoreCarteggio = ((JAXBElement<DComparcCarteggioFirmatario.FkVocQualificaAttoreCarteggio> ) value);
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DComparcCarteggioFirmatario.FkVocRuoloAttoreCarteggio }{@code >}
     *     
     */
    public JAXBElement<DComparcCarteggioFirmatario.FkVocRuoloAttoreCarteggio> getFkVocRuoloAttoreCarteggio() {
     ...
     *     
     */
    public void setFkVocRuoloAttoreCarteggio(JAXBElement<DComparcCarteggioFirmatario.FkVocRuoloAttoreCarteggio> value) {
        this.fkVocRuoloAttoreCarteggio = ((JAXBElement<DComparcCarteggioFirmatario.FkVocRuoloAttoreCarteggio> ) value);
    }
