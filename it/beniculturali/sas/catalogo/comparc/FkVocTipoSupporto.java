...
public class FkVocTipoSupporto {
    ...
    protected List<DVocTipoSupporto> dVocTipoSupporto;
     ...
     * This is why there is not a <CODE>set</CODE> method for the dVocTipoSupporto property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDVocTipoSupporto().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DVocTipoSupporto> getDVocTipoSupporto() {
        if (dVocTipoSupporto == null) {
            dVocTipoSupporto = new ArrayList<DVocTipoSupporto>();
        }
        return this.dVocTipoSupporto;
    }
