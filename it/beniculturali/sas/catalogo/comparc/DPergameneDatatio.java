...
public class DPergameneDatatio {
    ...
    @XmlElementRef(name = "date_inizio", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> dateInizio;
    @XmlElementRef(name = "date_fine", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class)
    ...
    public void setDateInizio(JAXBElement<XMLGregorianCalendar> value) {
        this.dateInizio = ((JAXBElement<XMLGregorianCalendar> ) value);
    }
