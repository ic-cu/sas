...
public class DComparcCondAccesso {
    ...
    public static class FkVocTipologiaConservatore {
        ...
        protected List<DVocTipologiaConservatore> dVocTipologiaConservatore;
         ...
         * This is why there is not a <CODE>set</CODE> method for the dVocTipologiaConservatore property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getDVocTipologiaConservatore().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<DVocTipologiaConservatore> getDVocTipologiaConservatore() {
            if (dVocTipologiaConservatore == null) {
                dVocTipologiaConservatore = new ArrayList<DVocTipologiaConservatore>();
            }
            return this.dVocTipologiaConservatore;
        }
