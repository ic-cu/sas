...
public class FkVocTipoFormato {
    ...
    protected List<DVocTipoFormato> dVocTipoFormato;
     ...
     * This is why there is not a <CODE>set</CODE> method for the dVocTipoFormato property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDVocTipoFormato().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DVocTipoFormato> getDVocTipoFormato() {
        if (dVocTipoFormato == null) {
            dVocTipoFormato = new ArrayList<DVocTipoFormato>();
        }
        return this.dVocTipoFormato;
    }
