...
public class DComparcAutoriEditoriComm {
    ...
    public static class FkVocQualificaCommittente {
        ...
        protected List<DVocQualificaCommittente> dVocQualificaCommittente;
         ...
         * This is why there is not a <CODE>set</CODE> method for the dVocQualificaCommittente property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getDVocQualificaCommittente().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<DVocQualificaCommittente> getDVocQualificaCommittente() {
            if (dVocQualificaCommittente == null) {
                dVocQualificaCommittente = new ArrayList<DVocQualificaCommittente>();
            }
            return this.dVocQualificaCommittente;
        }
