...
public class FkVocModalitaAcq {
    ...
    protected List<DVocModalitaAcq> dVocModalitaAcq;
     ...
     * This is why there is not a <CODE>set</CODE> method for the dVocModalitaAcq property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDVocModalitaAcq().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DVocModalitaAcq> getDVocModalitaAcq() {
        if (dVocModalitaAcq == null) {
            dVocModalitaAcq = new ArrayList<DVocModalitaAcq>();
        }
        return this.dVocModalitaAcq;
    }
