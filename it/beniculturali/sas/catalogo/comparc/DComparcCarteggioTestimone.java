 ...
 *       &lt;sequence>
 *         &lt;element name="text_nome_testimone_carteggio">
 *           &lt;simpleType>
...
@XmlType(name = "", propOrder = {
    "textNomeTestimoneCarteggio",
    "fkVocQualificaAttoreCarteggio",
    "fkVocRuoloAttoreCarteggio",
    "textNote"
})
@XmlRootElement(name = "d_comparc_carteggio_testimone")
public class DComparcCarteggioTestimone {

    @XmlElement(name = "text_nome_testimone_carteggio", required = true, nillable = true)
    protected String textNomeTestimoneCarteggio;
    ...
    protected JAXBElement<DComparcCarteggioTestimone.FkVocQualificaAttoreCarteggio> fkVocQualificaAttoreCarteggio;
    ...
    protected JAXBElement<DComparcCarteggioTestimone.FkVocRuoloAttoreCarteggio> fkVocRuoloAttoreCarteggio;
    ...
    /**
     * Gets the value of the textNomeTestimoneCarteggio property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getTextNomeTestimoneCarteggio() {
        return textNomeTestimoneCarteggio;
    }

    /**
     * Sets the value of the textNomeTestimoneCarteggio property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setTextNomeTestimoneCarteggio(String value) {
        this.textNomeTestimoneCarteggio = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DComparcCarteggioTestimone.FkVocQualificaAttoreCarteggio }{@code >}
     *     
     */
    public JAXBElement<DComparcCarteggioTestimone.FkVocQualificaAttoreCarteggio> getFkVocQualificaAttoreCarteggio() {
     ...
     *     
     */
    public void setFkVocQualificaAttoreCarteggio(JAXBElement<DComparcCarteggioTestimone.FkVocQualificaAttoreCarteggio> value) {
        this.fkVocQualificaAttoreCarteggio = ((JAXBElement<DComparcCarteggioTestimone.FkVocQualificaAttoreCarteggio> ) value);
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DComparcCarteggioTestimone.FkVocRuoloAttoreCarteggio }{@code >}
     *     
     */
    public JAXBElement<DComparcCarteggioTestimone.FkVocRuoloAttoreCarteggio> getFkVocRuoloAttoreCarteggio() {
     ...
     *     
     */
    public void setFkVocRuoloAttoreCarteggio(JAXBElement<DComparcCarteggioTestimone.FkVocRuoloAttoreCarteggio> value) {
        this.fkVocRuoloAttoreCarteggio = ((JAXBElement<DComparcCarteggioTestimone.FkVocRuoloAttoreCarteggio> ) value);
    }
