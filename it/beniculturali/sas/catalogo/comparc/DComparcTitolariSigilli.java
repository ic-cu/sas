...
public class DComparcTitolariSigilli {
    ...
    public static class FkVocTipoRuoloTitolare {
        ...
        protected List<DVocTipoRuoloTitolare> dVocTipoRuoloTitolare;
         ...
         * This is why there is not a <CODE>set</CODE> method for the dVocTipoRuoloTitolare property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getDVocTipoRuoloTitolare().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<DVocTipoRuoloTitolare> getDVocTipoRuoloTitolare() {
            if (dVocTipoRuoloTitolare == null) {
                dVocTipoRuoloTitolare = new ArrayList<DVocTipoRuoloTitolare>();
            }
            return this.dVocTipoRuoloTitolare;
        }
