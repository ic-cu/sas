...
public class DSogpPGenere {
    ...
    @XmlElement(name = "fk_voc_tipo_genere", required = true, type = Integer.class, nillable = true)
    protected Integer fkVocTipoGenere;
     ...
     *     
     */
    public Integer getFkVocTipoGenere() {
     ...
     *     
     */
    public void setFkVocTipoGenere(Integer value) {
