...
public class DSogpCondGiuridica {
    ...
    public static class FkVocCondGiuridica {
        ...
        protected List<DVocCondGiuridica> dVocCondGiuridica;
         ...
         * This is why there is not a <CODE>set</CODE> method for the dVocCondGiuridica property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getDVocCondGiuridica().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<DVocCondGiuridica> getDVocCondGiuridica() {
            if (dVocCondGiuridica == null) {
                dVocCondGiuridica = new ArrayList<DVocCondGiuridica>();
            }
            return this.dVocCondGiuridica;
        }
