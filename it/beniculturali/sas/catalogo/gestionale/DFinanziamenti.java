...
public class DFinanziamenti {
    ...
    @XmlElementRef(name = "descr_progetto", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    protected JAXBElement<String> descrProgetto;
    @XmlElementRef(name = "nume_stanz_richiesto", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> numeStanzRichiesto;
    @XmlElementRef(name = "nume_stanz_effettivo", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> numeStanzEffettivo;
    @XmlElementRef(name = "text_tipo_finanziamento", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    protected JAXBElement<String> textTipoFinanziamento;
    @XmlElementRef(name = "text_capitolo_spesa", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    protected JAXBElement<String> textCapitoloSpesa;
    @XmlElementRef(name = "text_esercizio_finanziario", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    protected JAXBElement<String> textEsercizioFinanziario;
    @XmlElementRef(name = "date_inizio_lavori", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> dateInizioLavori;
    @XmlElementRef(name = "date_fine_lavori", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    protected JAXBElement<XMLGregorianCalendar> dateFineLavori;
    @XmlElementRef(name = "text_estremi_contratto", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class)
    ...
    public void setDescrProgetto(JAXBElement<String> value) {
        this.descrProgetto = ((JAXBElement<String> ) value);
    }
    ...
    public void setNumeStanzRichiesto(JAXBElement<BigDecimal> value) {
        this.numeStanzRichiesto = ((JAXBElement<BigDecimal> ) value);
    }
    ...
    public void setNumeStanzEffettivo(JAXBElement<BigDecimal> value) {
        this.numeStanzEffettivo = ((JAXBElement<BigDecimal> ) value);
    }
    ...
    public void setTextTipoFinanziamento(JAXBElement<String> value) {
        this.textTipoFinanziamento = ((JAXBElement<String> ) value);
    }
    ...
    public void setTextCapitoloSpesa(JAXBElement<String> value) {
        this.textCapitoloSpesa = ((JAXBElement<String> ) value);
    }
    ...
    public void setTextEsercizioFinanziario(JAXBElement<String> value) {
        this.textEsercizioFinanziario = ((JAXBElement<String> ) value);
    }
    ...
    public void setDateInizioLavori(JAXBElement<XMLGregorianCalendar> value) {
        this.dateInizioLavori = ((JAXBElement<XMLGregorianCalendar> ) value);
    }
    ...
    public void setDateFineLavori(JAXBElement<XMLGregorianCalendar> value) {
        this.dateFineLavori = ((JAXBElement<XMLGregorianCalendar> ) value);
    }
    ...
    public void setTextEstremiContratto(JAXBElement<String> value) {
        this.textEstremiContratto = ((JAXBElement<String> ) value);
    }
