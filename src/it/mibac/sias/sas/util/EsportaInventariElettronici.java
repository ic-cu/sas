 ...
 */
public class EsportaInventariElettronici
{
	 ...
	 */
	public EsportaInventariElettronici()
	{
		try
		{
			loadConfig();
			...
			log.info("Inizio esportazione inventari");
		}
...
/*
 * Si istanzia la lista di envelope ewl e la lista deinventari ei, passando per la classe
 * InventariElettronici. Il metodo createEntity ha un nome improprio, perché in realtà ritorna una
