 ...
 */
public class EsportaRelazioniComplessi
{
	 ...
	 */
	public EsportaRelazioniComplessi()
	{
		try
		{
			loadConfig();
			...
			log.info("Inizio esportazione relazioni complessi");
		}
 ...
 */
		...
		rc = new RelazioniComplessi(db.getConnection());
		ri = rc.createEntity(idIstituto);
