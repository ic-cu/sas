...
public class DContraente {
    ...
    @XmlElementRef(name = "text_mail", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textMail;
    @XmlElementRef(name = "text_descr_intervento", namespace = "http://sas.beniculturali.it/catalogo/gestionale", type = JAXBElement.class, required = false)
    ...
    public void setTextDescrIntervento(JAXBElement<String> value) {
        this.textDescrIntervento = value;
    }
