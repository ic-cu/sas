...
public class DSalaStudio {
    ...
    @XmlElementRef(name = "text_note_sala_studio", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textNoteSalaStudio;
    @XmlElementRef(name = "text_note", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "date_estremo_remoto", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateEstremoRemoto;
    @XmlElementRef(name = "text_secolo_rm", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textSecoloRm;
    @XmlElementRef(name = "fk_voc_validita_dtrm", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<DSalaStudio.FkVocValiditaDtrm> fkVocValiditaDtrm;
    @XmlElementRef(name = "fk_voc_specifica_serm", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<DSalaStudio.FkVocSpecificaSerm> fkVocSpecificaSerm;
    @XmlElementRef(name = "date_estremo_recente", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateEstremoRecente;
    @XmlElementRef(name = "text_secolo_re", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textSecoloRe;
    @XmlElementRef(name = "fk_voc_validita_dtre", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<DSalaStudio.FkVocValiditaDtre> fkVocValiditaDtre;
    @XmlElementRef(name = "fk_voc_specifica_sere", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
    protected JAXBElement<DSalaStudio.FkVocSpecificaSere> fkVocSpecificaSere;
    @XmlElementRef(name = "text_note_data", namespace = "http://sas.beniculturali.it/catalogo/sala_studio", type = JAXBElement.class, required = false)
