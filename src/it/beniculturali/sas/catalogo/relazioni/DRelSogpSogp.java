...
public class DRelSogpSogp {
    ...
    @XmlElementRef(name = "fk_voc_qual_rel_sogp", namespace = "http://sas.beniculturali.it/catalogo/relazioni", type = JAXBElement.class, required = false)
    protected JAXBElement<DRelSogpSogp.FkVocQualRelSogp> fkVocQualRelSogp;
    @XmlElementRef(name = "fk_voc_rel_sogp", namespace = "http://sas.beniculturali.it/catalogo/relazioni", type = JAXBElement.class, required = false)
    protected JAXBElement<DRelSogpSogp.FkVocRelSogp> fkVocRelSogp;
    @XmlElementRef(name = "text_relazione", namespace = "http://sas.beniculturali.it/catalogo/relazioni", type = JAXBElement.class, required = false)
