...
public class DComparcSigilli {
    ...
    @XmlElementRef(name = "text_anno_inizio", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textAnnoInizio;
    @XmlElementRef(name = "text_anno_fine", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textAnnoFine;
    @XmlElementRef(name = "text_datazione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "text_riferimento_documento", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textRiferimentoDocumento;
    @XmlElementRef(name = "text_nota_diplomatico_archivistica", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textNotaDiplomaticoArchivistica;
    @XmlElementRef(name = "text_posizione_nel_documento", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "fk_voc_modo_apposizione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<DComparcSigilli.FkVocModoApposizione> fkVocModoApposizione;
    @XmlElementRef(name = "text_descr_attacchi", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textDescrAttacchi;
    @XmlElementRef(name = "text_sistema_protezione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textSistemaProtezione;
    @XmlElementRef(name = "text_altri_materiali", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textAltriMateriali;
    @XmlElementRef(name = "text_autenticita", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textAutenticita;
    @XmlElementRef(name = "text_descrizione_sigillo", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    public void setTextRiferimentoDocumento(JAXBElement<String> value) {
        this.textRiferimentoDocumento = value;
    }
    ...
    public void setTextNotaDiplomaticoArchivistica(JAXBElement<String> value) {
        this.textNotaDiplomaticoArchivistica = value;
    }
    ...
    public void setTextPosizioneNelDocumento(JAXBElement<String> value) {
        this.textPosizioneNelDocumento = value;
    }
    ...
    public void setFkVocModoApposizione(JAXBElement<DComparcSigilli.FkVocModoApposizione> value) {
        this.fkVocModoApposizione = value;
    }
    ...
    public void setTextSistemaProtezione(JAXBElement<String> value) {
        this.textSistemaProtezione = value;
    }
    ...
    public void setTextDescrizioneSigillo(JAXBElement<String> value) {
        this.textDescrizioneSigillo = value;
    }
