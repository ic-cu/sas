...
public class DComparcCartografieCaratteriEstrinseci {
    ...
    @XmlElementRef(name = "fk_voc_proc_grafico", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<DComparcCartografieCaratteriEstrinseci.FkVocProcGrafico> fkVocProcGrafico;
    @XmlElementRef(name = "fk_voc_mediazioni_grafiche", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<DComparcCartografieCaratteriEstrinseci.FkVocMediazioniGrafiche> fkVocMediazioniGrafiche;
    @XmlElementRef(name = "fk_voc_tipo_supporto_cart", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<DComparcCartografieCaratteriEstrinseci.FkVocTipoSupportoCart> fkVocTipoSupportoCart;
    @XmlElementRef(name = "text_note_supporto", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textNoteSupporto;
    @XmlElementRef(name = "nume_altezza", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> numeAltezza;
    @XmlElementRef(name = "nume_larghezza", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> numeLarghezza;
    @XmlElementRef(name = "nume_spessore", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> numeSpessore;
    @XmlElementRef(name = "text_dimensioni_raffigurazione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textDimensioniRaffigurazione;
    @XmlElementRef(name = "fk_voc_tipo_materiale", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<DComparcCartografieCaratteriEstrinseci.FkVocTipoMateriale> fkVocTipoMateriale;
    @XmlElementRef(name = "fk_voc_tipo_numerazione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<DComparcCartografieCaratteriEstrinseci.FkVocTipoNumerazione> fkVocTipoNumerazione;
    @XmlElementRef(name = "text_note_numerazione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    public void setFkVocMediazioniGrafiche(JAXBElement<DComparcCartografieCaratteriEstrinseci.FkVocMediazioniGrafiche> value) {
        this.fkVocMediazioniGrafiche = value;
    }
    ...
    public void setFkVocTipoSupportoCart(JAXBElement<DComparcCartografieCaratteriEstrinseci.FkVocTipoSupportoCart> value) {
        this.fkVocTipoSupportoCart = value;
    }
    ...
    public void setTextDimensioniRaffigurazione(JAXBElement<String> value) {
        this.textDimensioniRaffigurazione = value;
    }
    ...
    public void setFkVocTipoNumerazione(JAXBElement<DComparcCartografieCaratteriEstrinseci.FkVocTipoNumerazione> value) {
        this.fkVocTipoNumerazione = value;
    }
    ...
    public void setTextNoteNumerazione(JAXBElement<String> value) {
        this.textNoteNumerazione = value;
    }
