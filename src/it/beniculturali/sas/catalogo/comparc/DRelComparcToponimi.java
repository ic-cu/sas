...
public class DRelComparcToponimi {
    ...
    @XmlElementRef(name = "fk_voc_qualifica_toponimo", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<DRelComparcToponimi.FkVocQualificaToponimo> fkVocQualificaToponimo;
    @XmlElementRef(name = "fk_voc_ruolo_toponimo", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    public void setFkVocQualificaToponimo(JAXBElement<DRelComparcToponimi.FkVocQualificaToponimo> value) {
        this.fkVocQualificaToponimo = value;
    }
