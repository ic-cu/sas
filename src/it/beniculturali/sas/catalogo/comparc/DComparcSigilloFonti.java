...
public class DComparcSigilloFonti {
    ...
    @XmlElementRef(name = "text_matrice", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textMatrice;
    @XmlElementRef(name = "text_altre_impronte_sigillo", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textAltreImpronteSigillo;
    @XmlElementRef(name = "text_altre_impronte_titolare", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textAltreImpronteTitolare;
    @XmlElementRef(name = "text_edizione_esemplare", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    public void setTextAltreImpronteSigillo(JAXBElement<String> value) {
        this.textAltreImpronteSigillo = value;
    }
    ...
    public void setTextAltreImpronteTitolare(JAXBElement<String> value) {
        this.textAltreImpronteTitolare = value;
    }
    ...
    public void setTextEdizioneEsemplare(JAXBElement<String> value) {
        this.textEdizioneEsemplare = value;
    }
