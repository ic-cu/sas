...
public class DAcquisizione {
    ...
    @XmlElement(name = "nume_rpc", required = true)
    protected BigDecimal numeRpc;
    @XmlElement(name = "text_soggetto_versatore", required = true)
    protected String textSoggettoVersatore;
    @XmlElementRef(name = "fk_voc_tipo_acquisizione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<DAcquisizione.FkVocTipoAcquisizione> fkVocTipoAcquisizione;
    @XmlElementRef(name = "date_acquisizione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateAcquisizione;
    @XmlElementRef(name = "text_note_acquisizione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textNoteAcquisizione;
    @XmlElementRef(name = "text_note_direzione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    public void setFkVocTipoAcquisizione(JAXBElement<DAcquisizione.FkVocTipoAcquisizione> value) {
        this.fkVocTipoAcquisizione = value;
    }
    ...
    public void setTextNoteAcquisizione(JAXBElement<String> value) {
        this.textNoteAcquisizione = value;
    }
