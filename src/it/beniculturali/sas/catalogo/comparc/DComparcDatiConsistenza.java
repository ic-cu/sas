...
public class DComparcDatiConsistenza {
    ...
    @XmlElementRef(name = "text_info_numerazione", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "flg_cartulato_sn", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flgCartulatoSn;
    @XmlElementRef(name = "flg_carte_pagine_cp", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flgCartePagineCp;
    @XmlElementRef(name = "nume_numero_carta", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> numeNumeroCarta;
    @XmlElementRef(name = "flg_recto_verso", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    public void setTextInfoNumerazione(JAXBElement<String> value) {
        this.textInfoNumerazione = value;
    }
