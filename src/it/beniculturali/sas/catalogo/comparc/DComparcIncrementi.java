...
public class DComparcIncrementi {
    ...
    @XmlElementRef(name = "nume_metri_lineari_complessivi", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> numeMetriLineariComplessivi;
    @XmlElementRef(name = "date_data_caricamento", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    public void setNumeMetriLineariComplessivi(JAXBElement<Integer> value) {
        this.numeMetriLineariComplessivi = value;
    }
    ...
    public void setDateDataCaricamento(JAXBElement<XMLGregorianCalendar> value) {
        this.dateDataCaricamento = value;
    }
