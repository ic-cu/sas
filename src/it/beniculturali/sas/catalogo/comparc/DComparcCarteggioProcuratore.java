 ...
 *       &lt;sequence>
 *         &lt;element name="text_nome_procuratore_carteggio">
 *           &lt;simpleType>
...
@XmlType(name = "", propOrder = {
    "textNomeProcuratoreCarteggio",
    "fkVocQualificaAttoreCarteggio",
    "fkVocRuoloAttoreCarteggio",
    "textNote"
})
@XmlRootElement(name = "d_comparc_carteggio_procuratore")
public class DComparcCarteggioProcuratore {

    @XmlElement(name = "text_nome_procuratore_carteggio", required = true, nillable = true)
    protected String textNomeProcuratoreCarteggio;
    ...
    protected JAXBElement<DComparcCarteggioProcuratore.FkVocQualificaAttoreCarteggio> fkVocQualificaAttoreCarteggio;
    ...
    protected JAXBElement<DComparcCarteggioProcuratore.FkVocRuoloAttoreCarteggio> fkVocRuoloAttoreCarteggio;
    ...
    /**
     * Gets the value of the textNomeProcuratoreCarteggio property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getTextNomeProcuratoreCarteggio() {
        return textNomeProcuratoreCarteggio;
    }

    /**
     * Sets the value of the textNomeProcuratoreCarteggio property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setTextNomeProcuratoreCarteggio(String value) {
        this.textNomeProcuratoreCarteggio = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DComparcCarteggioProcuratore.FkVocQualificaAttoreCarteggio }{@code >}
     *     
     */
    public JAXBElement<DComparcCarteggioProcuratore.FkVocQualificaAttoreCarteggio> getFkVocQualificaAttoreCarteggio() {
     ...
     *     
     */
    public void setFkVocQualificaAttoreCarteggio(JAXBElement<DComparcCarteggioProcuratore.FkVocQualificaAttoreCarteggio> value) {
        this.fkVocQualificaAttoreCarteggio = ((JAXBElement<DComparcCarteggioProcuratore.FkVocQualificaAttoreCarteggio> ) value);
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link DComparcCarteggioProcuratore.FkVocRuoloAttoreCarteggio }{@code >}
     *     
     */
    public JAXBElement<DComparcCarteggioProcuratore.FkVocRuoloAttoreCarteggio> getFkVocRuoloAttoreCarteggio() {
     ...
     *     
     */
    public void setFkVocRuoloAttoreCarteggio(JAXBElement<DComparcCarteggioProcuratore.FkVocRuoloAttoreCarteggio> value) {
        this.fkVocRuoloAttoreCarteggio = ((JAXBElement<DComparcCarteggioProcuratore.FkVocRuoloAttoreCarteggio> ) value);
    }
