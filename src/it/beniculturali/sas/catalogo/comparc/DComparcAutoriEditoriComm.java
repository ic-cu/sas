...
public class DComparcAutoriEditoriComm {
    ...
    @XmlElement(name = "flg_autore_editore_committente_aec", required = true)
    ...
    @XmlElementRef(name = "fk_voc_qualifica_committente", namespace = "http://sas.beniculturali.it/catalogo/comparc", type = JAXBElement.class, required = false)
    ...
    public void setFkVocQualificaCommittente(JAXBElement<DComparcAutoriEditoriComm.FkVocQualificaCommittente> value) {
        this.fkVocQualificaCommittente = value;
    }
