...
public class DAmbitoTerritoriale {
    ...
    @XmlElementRef(name = "text_estr_crono_testuali", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textEstrCronoTestuali;
    @XmlElementRef(name = "date_estremo_remoto", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateEstremoRemoto;
    @XmlElementRef(name = "text_secolo_rm", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textSecoloRm;
    @XmlElementRef(name = "fk_voc_validita_dtrm", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<DAmbitoTerritoriale.FkVocValiditaDtrm> fkVocValiditaDtrm;
    @XmlElementRef(name = "fk_voc_specifica_serm", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<DAmbitoTerritoriale.FkVocSpecificaSerm> fkVocSpecificaSerm;
    @XmlElementRef(name = "date_estremo_recente", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateEstremoRecente;
    @XmlElementRef(name = "text_secolo_re", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textSecoloRe;
    @XmlElementRef(name = "fk_voc_validita_dtre", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<DAmbitoTerritoriale.FkVocValiditaDtre> fkVocValiditaDtre;
    @XmlElementRef(name = "fk_voc_specifica_sere", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<DAmbitoTerritoriale.FkVocSpecificaSere> fkVocSpecificaSere;
    @XmlElementRef(name = "text_note_data", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textNoteData;
    @XmlElementRef(name = "descr_ambito", namespace = "http://sas.beniculturali.it/catalogo/elmctx", type = JAXBElement.class, required = false)
