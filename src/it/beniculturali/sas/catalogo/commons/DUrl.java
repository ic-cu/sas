...
public class DUrl {
    ...
    @XmlElementRef(name = "text_descr_url", namespace = "http://sas.beniculturali.it/catalogo/commons", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textDescrUrl;
    @XmlElementRef(name = "date_url", namespace = "http://sas.beniculturali.it/catalogo/commons", type = JAXBElement.class, required = false)
