...
@XmlRootElement(name = "d_url")
public class DUrl {

    @XmlElement(name = "text_titolo_url", required = true, nillable = true)
    protected String textTitoloUrl;
    @XmlElement(name = "text_url", required = true)
    protected String textUrl;
    @XmlElementRef(name = "text_descr_url", namespace = "http://sas.beniculturali.it/catalogo/commons", type = JAXBElement.class)
    protected JAXBElement<String> textDescrUrl;
    @XmlElementRef(name = "date_url", namespace = "http://sas.beniculturali.it/catalogo/commons", type = JAXBElement.class)
     ...
     *     
     */
    public String getTextTitoloUrl() {
     ...
     *     
     */
    public void setTextTitoloUrl(String value) {
