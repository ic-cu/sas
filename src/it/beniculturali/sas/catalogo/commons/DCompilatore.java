...
public class DCompilatore {
    ...
    @XmlElementRef(name = "fk_voc_tipo_lingua", namespace = "http://sas.beniculturali.it/catalogo/commons", type = JAXBElement.class, required = false)
    protected JAXBElement<DCompilatore.FkVocTipoLingua> fkVocTipoLingua;
    @XmlElementRef(name = "fk_voc_tipo_scrittura", namespace = "http://sas.beniculturali.it/catalogo/commons", type = JAXBElement.class, required = false)
