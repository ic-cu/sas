...
public class DSogpPAttivita {
    ...
    @XmlElementRef(name = "fk_voc_tipo_attivita", namespace = "http://sas.beniculturali.it/catalogo/sogp", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "fk_voc_validita_serm", namespace = "http://sas.beniculturali.it/catalogo/sogp", type = JAXBElement.class, required = false)
    protected JAXBElement<DSogpPAttivita.FkVocValiditaSerm> fkVocValiditaSerm;
    @XmlElementRef(name = "fk_voc_specifica_dtrm", namespace = "http://sas.beniculturali.it/catalogo/sogp", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "fk_voc_validita_sere", namespace = "http://sas.beniculturali.it/catalogo/sogp", type = JAXBElement.class, required = false)
    protected JAXBElement<DSogpPAttivita.FkVocValiditaSere> fkVocValiditaSere;
    @XmlElementRef(name = "fk_voc_specifica_dtre", namespace = "http://sas.beniculturali.it/catalogo/sogp", type = JAXBElement.class, required = false)
