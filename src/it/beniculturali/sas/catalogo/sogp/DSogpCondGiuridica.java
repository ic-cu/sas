...
public class DSogpCondGiuridica {
    ...
    @XmlElementRef(name = "fk_voc_validita_dttm", namespace = "http://sas.beniculturali.it/catalogo/sogp", type = JAXBElement.class, required = false)
