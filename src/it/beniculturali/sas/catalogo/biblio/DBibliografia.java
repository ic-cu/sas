...
public class DBibliografia {
    ...
    @XmlElementRef(name = "codi_isbn", namespace = "http://sas.beniculturali.it/catalogo/biblio", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codiIsbn;
    @XmlElementRef(name = "codi_opac_sbn", namespace = "http://sas.beniculturali.it/catalogo/biblio", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codiOpacSbn;
    @XmlElementRef(name = "text_metadati_opac", namespace = "http://sas.beniculturali.it/catalogo/biblio", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textMetadatiOpac;
    @XmlElementRef(name = "text_biblioteca", namespace = "http://sas.beniculturali.it/catalogo/biblio", type = JAXBElement.class, required = false)
