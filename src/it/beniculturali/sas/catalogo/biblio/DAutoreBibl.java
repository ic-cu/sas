...
public class DAutoreBibl {
    ...
    @XmlElementRef(name = "text_luogo_nascita", namespace = "http://sas.beniculturali.it/catalogo/biblio", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textLuogoNascita;
    @XmlElementRef(name = "date_nascita", namespace = "http://sas.beniculturali.it/catalogo/biblio", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> dateNascita;
    @XmlElementRef(name = "text_luogo_morte", namespace = "http://sas.beniculturali.it/catalogo/biblio", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textLuogoMorte;
    @XmlElementRef(name = "date_morte", namespace = "http://sas.beniculturali.it/catalogo/biblio", type = JAXBElement.class, required = false)
