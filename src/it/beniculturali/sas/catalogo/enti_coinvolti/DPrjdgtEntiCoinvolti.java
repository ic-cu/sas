...
public class DPrjdgtEntiCoinvolti {
    ...
    @XmlElementRef(name = "text_descrizione", namespace = "http://sas.beniculturali.it/catalogo/enti_coinvolti", type = JAXBElement.class, required = false)
    protected JAXBElement<String> textDescrizione;
    @XmlElementRef(name = "fk_voc_tipo_qualifica_ente", namespace = "http://sas.beniculturali.it/catalogo/enti_coinvolti", type = JAXBElement.class, required = false)
    ...
    public void setFkVocTipoQualificaEnte(JAXBElement<DPrjdgtEntiCoinvolti.FkVocTipoQualificaEnte> value) {
        this.fkVocTipoQualificaEnte = value;
    }
